...
$root.common = (function () {
  ...
  common.Tx = (function () {
    ...
    Tx.toObject = function toObject(message, options) {
      ...
      if (message.chain != null && message.hasOwnProperty('chain')) object.chain = message.chain
      if (message.fromAddress != null && message.hasOwnProperty('fromAddress')) object.fromAddress = message.fromAddress
      ...
      if (message.gas && message.gas.length) {
        object.gas = []
        for (var j = 0; j < message.gas.length; ++j) object.gas[j] = $root.common.Coin.toObject(message.gas[j], options)
      }
